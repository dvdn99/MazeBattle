...
public class MazeGenerator : MonoBehaviour {
    ...
    // a dictionary to hold and locate all cells in maze
    private Dictionary<Vector2, Cell> allCells = new Dictionary<Vector2, Cell>();

    // a list to hold unvisited cells
    private List<Cell> unvisited = new List<Cell>();

    // a list to store on stack cells, cells being checked during generation
    private List<Cell> stack = new List<Cell>();

    // an array will hold 4 centre room cells, from 0 to 3 
    private Cell[] centreCells = new Cell[4];

    // cell variables to hold current cell and checking cells
